...
$total_de_comunicados = mysqli_num_rows($result_comunicado);
    ...
    $query_table = "SELECT publicacao.titulo, publicacao.cod_publicacao, publicacao.data_publicacao, publicacao.autor FROM publicacao LIMIT $lista_inicio, $limite_dados;";

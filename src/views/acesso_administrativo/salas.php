...
<body>
    ...
    <div class="container">
        <div class="box_table" id="box_table">
            ...
            <div class="add_user" onclick="window.location='cadastro_sala.php';">
                <img src="../../img/icons8-porta-52.png" class="iconAddUser" alt="Ilustração para adição de novo usuário">
                <p>Adicionar sala</p>
            </div>
            <table class="table table-striped" id="table table-striped">
                ...
                <tbody class="resultado">
                    <?php
                        while ($array_sala = mysqli_fetch_assoc($result_table)) {
                            $status = "";
                            if($array_sala['status_funcionamento'] == 1){
                                $status = "Ativa";
                            }else{
                                $status = "Desativada";
                            }
                            echo "<tr>
                                    <th><input type='checkbox' id='vehicle3' name='vehicle3' value=".$array_sala['cod_sala']."></th>
                                    <td>". $array_sala['nome']."</td>
                                    <td>". $status."</td>
                                    <td> 
                                        <form method='POST' action=''>
                                            <input type='hidden' id='codFuncionario' name='cod_Funcionario' value=".$array_sala['cod_sala'].">
                                            <img class='icons_opcoes detalhes' data-sala=".$array_sala['cod_sala']." src='../../img/icons8-mais-zoom-52.png' alt='Ilustração para opção de ver mais detalhes'  data-toggle='modal' data-target='#exampleModalCenter'>
                                        </form>
